...
$(document).ready(function() {
    var text_max = 1000;
    $('#textarea_feedback_1000').html('You have ' + text_max + ' characters remaining');
    ...
    $('textarea').keyup(function() {
        ...
        if (text_length > text_max) {
          ...
          $('#textarea_feedback_1000').html('You have ' + text_reverse_negative + ' characters too many').addClass('nhsuk-error-message').removeClass('nhsuk-hint');

        } else {

          $('#textarea_feedback_1000').html('You have ' + text_remaining + ' characters remaining').removeClass('nhsuk-error-message').addClass('nhsuk-hint');
        }
